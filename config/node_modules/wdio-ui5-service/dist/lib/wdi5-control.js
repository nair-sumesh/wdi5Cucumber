...
var WDI5Control = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 6: return [4 /*yield*/, (0, executeControlMethod_1.clientSide_executeControlMethod)(webElement, methodName, this._browserInstance, args)];
                    case 7:
                        result = (_c.sent());
                        // create logging
                        ...
                        switch (_b) {
                            ...
                            case "empty": return [3 /*break*/, 12];
                            case "aggregation": return [3 /*break*/, 13];
                            case "none": return [3 /*break*/, 20];
                        }
                        return [3 /*break*/, 21];
                    ...
                    case 12:
                        ...
                        return [2 /*return*/, result.result];
                    case 13:
                        if (!((args.length > 0 && typeof args[0] === "boolean" && args[0] === false) || args.length === 0)) return [3 /*break*/, 15];
                        return [4 /*yield*/, this._retrieveElements(result.result)];
                    case 14: 
                    // get all if param is false or undefined
                    return [2 /*return*/, _c.sent()];
                    case 15:
                        if (!(String(args[0]) && typeof args[0] === "number")) return [3 /*break*/, 19];
                        if (!(args[0] <= result.result.length)) return [3 /*break*/, 17];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this._domId) return [3 /*break*/, 2];
                        return [4 /*yield*/, this._getControl({ selector: { id: this._domId } })];
                    case 1:
    ...
    WDI5Control.prototype._getControl = function (controlSelector) {
        ...
        if (controlSelector === void 0) { controlSelector = this._controlSelector; }
        return __awaiter(this, void 0, void 0, function () {
            var _result, status, domElement, id, aProtoFunctions, className;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
